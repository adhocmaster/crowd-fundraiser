...
class Crowd_Fundraiser_Campaign_Controller {
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @var      string    $loader    stores the render post.
	 */
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @var      string    $instance    stores the class instance.
	 */
	 ...
	 * @param      string    $hook_loader       specifies the behavior of the class constructor
	 */
	...
	/**
	 * get instance Crowd Fundraiser Campaign
	 *
	 *
	 * @since    1.0.0
	 * @param      string    $hook_loader       specifies the behavior of the instance
	 */
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $post_id       Is the identifier of the post data to send
	 * @param      string    $post       	It is the data to send
	 * @param      string    $update       	It is the data update
	 */
	...
	/**
	 * get payment button page url first
	 *
	 * @since    1.0.0
	 * @param      string    $campaign_id       It is the identifier of the campaign
	 */
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $content       html is the content plugin
	 */

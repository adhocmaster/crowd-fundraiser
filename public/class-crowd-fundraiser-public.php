 ...
 * @subpackage Crowd_Fundraiser/public
 */
...
class Crowd_Fundraiser_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $crowd_fundraiser       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->crowd_fundraiser, plugin_dir_url( __FILE__ ) . 'css/crowd-fundraiser-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->crowd_fundraiser, plugin_dir_url( __FILE__ ) . 'js/crowd-fundraiser-public.js', array( 'jquery' ), $this->version, false );
